...
namespace BuilderAssignment
{
    ...
    internal class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            RamenBowl misoRamen = chef.PrepareRamen(misoBuilder)!;
            RamenBowl spicyRamen = chef.PrepareRamen(spicyBuilder);
            RamenBowl veganRamen = chef.PrepareRamen(veganBuilder);

            string description = misoRamen.FinishedBowlOfRamen();
            string description1 = spicyRamen.FinishedBowlOfRamen();
            string description2= veganRamen.FinishedBowlOfRamen();
